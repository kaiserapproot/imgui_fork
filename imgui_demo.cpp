...
const char* ComboItemGetter(void* data, int n)
{
...
//        ImGui::Combo("combo 4 (function)", &item_current_4, [](void* data, int n) { return ((const char**)data)[n]; }, items, IM_ARRAYSIZE(items));
		// 変更後のコード
		ImGui::Combo("combo 4 (function)", &item_current_4, ComboItemGetter, items, IM_ARRAYSIZE(items));
        ImGui::TreePop();
    }
...
//        static ImGuiTreeNodeFlags tree_node_flags ; 
			tree_node_flags = ImGuiTreeNodeFlags_SpanAllColumns;
        ...
        if (ImGui::BeginTable("3ways", 3, flags))
        {
            ...
            struct MyTreeNode
            {
                ...
                static void DisplayNode(const MyTreeNode* node, const MyTreeNode* all_nodes)
                {
                    ...
                    {
                        bool open; 
						open = ImGui::TreeNodeEx(node->Name, tree_node_flags);
                        ImGui::TableNextColumn();
                        ImGui::TextDisabled("--");
                        ImGui::TableNextColumn();
    ...
    if (ImGui::TreeNode("Angled headers"))
    {
        ...
        static bool bools[columns_count * rows_count] = {0}; // Dummy storage selection storage
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Inputs"))
        {
            ...
            for (i = 0; i < IM_ARRAYSIZE(io.MouseDown); i++) if (ImGui::IsMouseDown(i)) { ImGui::SameLine(); ImGui::Text("b%d (%.02f secs)", i, io.MouseDownDuration[i]); }
...
//                ImU32 col_b = ImGui::GetColorU32(IM_COL32(255, 255, 255, 255));
				ImU32 col_a = ImGui::GetColorU32((ImU32)IM_COL32(0, 0, 0, 255));
				ImU32 col_b = ImGui::GetColorU32((ImU32)IM_COL32(255, 255, 255, 255));
 ...
 //               ImU32 col_b = ImGui::GetColorU32(IM_COL32(255, 0, 0, 255));
				ImU32 col_a = ImGui::GetColorU32((ImU32)IM_COL32(0, 255, 0, 255));
				ImU32 col_b = ImGui::GetColorU32((ImU32)IM_COL32(255, 0, 0, 255));
                draw_list->AddRectFilledMultiColor(p0, p1, col_a, col_b, col_b, col_a);
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        if (ImGui::BeginMenu("File"))
        {
            int open_count = 0;
//            for (MyDocument& doc : app.Documents)
			for (i = 0; i < app.Documents.Size; i++)
			{
				MyDocument& doc = app.Documents[i];
